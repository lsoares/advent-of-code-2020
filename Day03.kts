...
val puzzleInput = Scanner(FileInputStream(File(path))).asSequence().toList()

check(247 == countTrees(puzzleInput))
...
check(2983070376 == countTreesMultiplePredicates(puzzleInput))

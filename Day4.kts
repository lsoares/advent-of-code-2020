...
hcl:#cfa07d eyr:2025 pid:166559648 iyr:2011 ecl:brn hgt:59in""".trim().split("\n\n").map(::toPassport).asSequence()
...
// part 2
val sampleInput2 = """eyr:1972 cid:100 hcl:#18171d ecl:amb hgt:170 pid:186cm iyr:2018 byr:1926
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719""".trim().split("\n\n").map(::toPassport)
    .asSequence()
